        ...
        <section className="about">
          <div className="aboutContent">
            ...
            <p>
              ...
              and nerd. I’m originally from Michigan but I’ve lived for over 20
              years in the South. I currently live in Anderson, South Carolina
              where I root for the{' '}
            ...
            <div className="aboutImage">
              <div className="aboutImageGrid">
                <StaticImage
                  src="../../content/assets/rich_heav.jpg/"
                  alt="Rich Heav"
                />
                <em>
            ...
            <p>
              ...
              spending my life in pursuit of a greater calling than seeing Jesus
              change peoples lives and making Him famous through technology.
            </p>
            <p>
              I’m also a writer. I am passionate about helping people find their
              purpose and rediscover their passions. I also write about God,
              technology, writing (ironically), and other sundry things.
            </p>
            <p>
            ...
            <p>
              ...
              and edited with{' '}
              <OutboundLink href="https://atom.io/">Atom</OutboundLink>. Before
              this, my site was built using{' '}
            ...
            <p>
              ...
              , I’ve been to more than one Comic Con (although I haven’t started
              dressing up yet), and I’m beginning to get into comic books more
              and more. Is that a little frightening? I’m not sure yet.
            </p>
